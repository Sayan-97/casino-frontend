...
import GamesImage from "@/public/svgs/top-live-games.svg";
...
export default function LiveGames() {
  const filteredGames = games.filter((item) => item.category === "live" || item.category === "new");
  return (
    <section className="py-3 space-y-4">
      <div className="max-lg:container flex items-center justify-between">
        <Head image={GamesImage} title="Live Games" />
      ...
      <div className="max-lg:hidden grid grid-cols-3 gap-4 p-4 rounded-2xl" style={{
          background:
