...
import CasinoImage from "@/public/svgs/playing-cards.svg";
...
export default function LiveCasino() {
  const filteredGames = games.filter((item) => item.category === "live-casino");
  return (
    <section className="py-3 space-y-4">
      <div className="container flex items-center justify-between">
        <Head image={CasinoImage} title="Live Casino" />
